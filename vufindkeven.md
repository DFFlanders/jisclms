...
# Project Team #
  * **Project Director**:
  * **Project Manager**: Jason Harper J.L.Harper@kent.ac.uk
  * **Developer**:
  * **Account Manager**:
  * **Partners**:
    * **Consultants**:
...
<wiki:gadget url="http://google-code-feed-gadget.googlecode.com/svn/trunk/gadget.xml" up\_feeds="HTTP RSS FEED HERE" width="700" height="700" border="1" up\_showaddbutton="20"/>
  ...
  * Project Blog: http://blogs.kent.ac.uk/vufindkeven/
    * Feed:
  * Code Repository:
  * Technical Documentation:
  * End User Documentation:
  * Analytics Engine:
  * Project Website: http://www.kent.ac.uk/is/projects/vufindkeven/index.html
  * PIMS listing:
